/*
  # Fix Demo Mode Migration - Constraint Order Issue
  
  The subscription constraint needs to be updated before inserting demo data
*/

-- First, update subscription plan enum to include demo
...
-- Add demo user field to app_users table if not exists
...
-- Now create demo subscription (constraint is updated)
